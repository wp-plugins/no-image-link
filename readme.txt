...
Tags: remove, image, images, picture, link, links, no, none, File URL, URL, insert, default
...
1. This is what the default will look like once the plugin is installed and activated.
...
= 1.2 =
Added correct link to plugin site.

= 1.1 =
Updates WordPress version compatibility.